 ...
 * Generated for Laravel 5.3.4 on 2016-10-05.
 *
...
if (! function_exists('with')) {
    ...
    class Cart extends \Gloudemans\Shoppingcart\Facades\Cart{
        ...
        public static function update($rowId, $qty){
            \Gloudemans\Shoppingcart\Cart::update($rowId, $qty);
        }
    ...
    class Allpay extends \ScottChayaa\Allpay\Facade\Allpay{
         ...
         */
        public static function instance(){
            return \ScottChayaa\Allpay\Allpay::instance();
        }
        ...
        public static function i(){
            return \ScottChayaa\Allpay\Allpay::i();
        }
